...
def run():
    ...
    open('key.pem', 'w').write(crypto.dump_privatekey(crypto.FILETYPE_PEM, cakey).decode())
    open('cert.pem', 'w').write(crypto.dump_certificate(crypto.FILETYPE_PEM, cacert).decode())
