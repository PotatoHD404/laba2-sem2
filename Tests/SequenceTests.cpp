...
TEST(Sequence, ListSequence_GetSubsequence) {
    int a[] = {1, 2, 3, 4, 5};
    unique_ptr<Sequence<int>> arr1 = unique_ptr<Sequence<int>>(new ListSequence<int>(a, 5));
    unique_ptr<Sequence<int>>
            arr2 = unique_ptr<Sequence<int>>(arr1->GetSubsequence(0, 0));
    ...
    arr2 = unique_ptr<Sequence<int>>(arr1->GetSubsequence(0, 4));
    ...
    EXPECT_EQ (arr1->At(3), arr2->At(3));
    EXPECT_EQ (arr1->At(4), arr2->At(4));
    arr2 = unique_ptr<Sequence<int>>(arr1->GetSubsequence(2, 3));
...
TEST(Sequence, ArraySequence_GetSubsequence) {
    int a[] = {1, 2, 3, 4, 5};
    unique_ptr<Sequence<int>> arr1 = unique_ptr<Sequence<int>>(new ArraySequence<int>(a, 5));
    unique_ptr<Sequence<int>>
            arr2 = unique_ptr<Sequence<int>>(arr1->GetSubsequence(0, 0));
